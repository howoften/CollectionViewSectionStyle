...
@interface SecondViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,UICollectionViewSectionDecorationFlowLayout>
...
- (LLCollectionSectionDecorationModel *)collectionView:(UICollectionView *)collectionView layout:(LLCollectionSectionDecorationLayout*)collectionViewLayout configModelForSection:(NSInteger)section{
    ...
    model.decorateAreaKind = LLCollectionViewSectionDecorateAreaAll;
