...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    switch (indexPath.row) {
        ...
        case 12:{
            ...
            fourthVC.myAlignmentType = LLCollectionViewLayoutAlignmentTypeLeft;
        ...
        case 14:{
            FourthViewController *fourthVC = [[FourthViewController alloc]init];
            fourthVC.myAlignmentType = LLCollectionViewLayoutAlignmentTypeCenter;
            [self.navigationController pushViewController:fourthVC animated:YES];
            return;
        }break;
        case 15:{
            FourthViewController *fourthVC = [[FourthViewController alloc]init];
            fourthVC.myAlignmentType = LLCollectionViewLayoutAlignmentTypeRight;
            [self.navigationController pushViewController:fourthVC animated:YES];
            return;
        }break;
        case 16:{
            FourthViewController *fourthVC = [[FourthViewController alloc]init];
            fourthVC.myAlignmentType = LLCollectionViewLayoutAlignmentTypeRightAndStartR;
            [self.navigationController pushViewController:fourthVC animated:YES];
            return;
        }break;
